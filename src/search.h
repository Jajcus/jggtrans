...
void jabber_iq_get_search(struct stream_s *s,const char *from,const char *id,xmlnode q);
void jabber_iq_set_search(struct stream_s *s,const char *from,const char *id,xmlnode q);
